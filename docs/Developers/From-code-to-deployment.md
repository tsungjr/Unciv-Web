...
-   From my workstation - pull the latest changes and run the [translation generation](../Translating/Translation-generation.md#translation-generation-for-developers)
